...
Generating the dataframes and plots for the heatmaps
```{r}
...
complete_genomic_heatmap <- ggplot() +
    ggtitle("PANCAN model: Unfiltered Genomic Importance")+
  # Facet: Aneu
  geom_tile(
...
arm_filt_genomic_heatmap <-ggplot() +
    ggtitle("PANCAN model: Chromosome Arm Filtered Genomic Importance")+
  # Facet: Aneu
  geom_tile(
...
chrm_filt_genomic_heatmap <- ggplot() +
    ggtitle("PANCAN model: Chromosome Filtered Genomic Importance")+
  # Facet: Aneu
  geom_tile(
