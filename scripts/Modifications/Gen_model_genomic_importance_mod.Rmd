...
# Save the full filtered PANCAN feature importance df
full_filtered_cancer_feat_imp_name <- paste0(feat_imp_folder, "/full_filtered_PANCAN_feat_imp.csv")
write.csv(filtered_cancer_type_imp_df, full_filtered_cancer_feat_imp_name, row.names = FALSE)


# Filter the PANCAN feat imp df to the top genes only
...
top_filtered_feat_imp_name <- paste0(feat_imp_folder, "/top_genes_filtered_PANCAN_feat_imp.csv")
...
heatmap_genes_filtered_name <- paste0(feat_imp_folder, "/heatmap_genes_filtered_PANCAN_feat_imp_df.csv")
...
filtered_genomic_heatmap_name <- paste0(base_feat_imp_plot, "/filtered_genomic_heatmap_PANCAN.png")
