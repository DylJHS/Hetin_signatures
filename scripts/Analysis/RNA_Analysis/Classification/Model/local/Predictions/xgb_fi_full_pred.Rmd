...
write.csv(
  top_genes_complete,
  "Data/Gen_model_output/Results/Feature_importance/Top_genes_complete.csv"
)
...
write.csv(
  top_learners_long,
  "Data/Gen_model_output/Results/Feature_importance/Top_baselearners_complete.csv"
)
...
```{r}
look <- full_feature_imp_df %>%
  group_by(Feature) %>%
  summarise(median = median(Gain)) 
# %>%)
#   mutate(Gain = round(Gain, 3),
#          Same = ifelse(Feature == Target, "Yes", "No"))
```
...
write.csv(
  Cat_general_metrics,
  "Data/Gen_model_output/Results/Prediction/Gen_cat_metrics.csv"
)

write.csv(
  Reg_general_metrics,
  "Data/Gen_model_output/Results/Prediction/Gen_reg_metrics.csv"
)

write.csv(
  Class_metrics_df,
  "Data/Gen_model_output/Results/Prediction/Gen_cat_class_metrics.csv"
)
```
